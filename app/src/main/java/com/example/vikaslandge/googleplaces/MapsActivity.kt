...
import com.example.vikaslandge.googleplaces.R.id.list_item
import com.example.vikaslandge.googleplaces.R.id.name
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        if (intent.getBooleanExtra("from_showall",
            ...
            for (item in list_new!!) {
                val location = LatLng(item.geometry.location.lat,
